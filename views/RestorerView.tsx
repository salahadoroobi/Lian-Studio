    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-4 md:p-8">
            ...
            <div className="flex flex-col gap-6 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm">
                ...
                <div>
                    <label htmlFor="additional-instructions" className="block text-lg font-semibold text-brand-primary dark:text-gray-300 mb-2">{t('restorer_instructions_label')}</label>
                    <textarea
