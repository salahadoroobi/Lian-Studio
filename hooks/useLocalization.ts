...
const translations = {
  ...
  ar: {
    ...
    landing_importance_desc: 'في عالم يعتمد على المحتوى الرقمي الجذاب، أصبحت القدرة على تحويل الأفكار إلى وسائط احترافية عالية الجودة أمراً ضرورياً. استوديو ليان يزيل الحواجز التقنية، ويمكّن كل مبدع—من المحترفين إلى الهواة—من تحقيق رؤيتهم في أي وسيط بسهولة ودقة لا مثيل لها.',
