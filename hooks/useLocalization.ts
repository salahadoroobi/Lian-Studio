...
const translations = {
  en: {
    ...
    landing_about_desc: 'Lian Studio is your creative gateway to new horizons in digital art. We offer an integrated suite of artistic tools, powered by the latest AI technology from Gemini, designed to be your partner in every step of your creative journey—from initial concept to final masterpiece.',
    landing_importance_title: 'Why Lian Studio?',
    landing_importance_desc: 'In an era driven by visual content, the ability to transform ideas into stunning images has never been more crucial. Lian Studio breaks down the barriers of skill and time, empowering every artist—professional or hobbyist—to realize their vision with ease and precision, unlocking limitless creative possibilities.',
    landing_goals_title: 'Our Mission',
    landing_goals_desc: 'Our mission is to empower creativity by placing the most powerful AI technologies at your fingertips through a simple, elegant interface. We strive to be the spark that inspires artists and creators to produce exceptional works of art that leave an unforgettable visual impact.',
  ...
  ar: {
    ...
    landing_about_desc: 'استوديو ليان هو بوابتك الإبداعية لاستكشاف آفاق جديدة في عالم الفن الرقمي. نحن نقدم مجموعة متكاملة من الأدوات الفنية المدعومة بأحدث تقنيات الذكاء الاصطناعي من Gemini، مصممة بعناية لتكون شريكك في كل خطوة من خطوات رحلتك الإبداعية، من الفكرة الأولية إلى التحفة النهائية.',
    landing_importance_title: 'لماذا استوديو ليان؟',
    landing_importance_desc: 'في عصر السرعة والمحتوى البصري، القدرة على تحويل الأفكار إلى صور مذهلة لم تكن أكثر أهمية من الآن. استوديو ليان يكسر حواجز المهارة والوقت، ويمكّن كل فنان، محترفًا كان أو هاويًا، من تجسيد رؤيته الفنية بكل سهولة ودقة، فاتحًا الباب أمام تجارب إبداعية لا حدود لها.',
    landing_goals_title: 'مهمتنا',
    landing_goals_desc: 'مهمتنا هي تمكين الإبداع عبر جعل أقوى تقنيات الذكاء الاصطناعي في متناول يديك بواجهة بسيطة وأنيقة. نحن نسعى لنكون الشرارة التي تلهم الفنانين والمبدعين لإنتاج أعمال فنية استثنائية تترك أثرًا بصريًا لا يُنسى.',
