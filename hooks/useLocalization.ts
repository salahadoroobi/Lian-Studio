...
const translations = {
  en: {
    ...
    translator_input_label: 'Text to Translate',
    translator_input_placeholder: 'Enter text here...',
    ...
    translating_title: 'Translating Text...',
    translating_desc: 'The AI is translating your text. Please wait.',
    copy_success: 'Copied!',
  ...
  ar: {
    ...
    translator_input_label: 'النص المراد ترجمته',
    translator_input_placeholder: 'أدخل النص هنا...',
    ...
    translating_title: 'جاري ترجمة النص...',
    translating_desc: 'الذكاء الاصطناعي يترجم النص الخاص بك. يرجى الانتظار.',
