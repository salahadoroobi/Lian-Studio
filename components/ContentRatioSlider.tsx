...
export const ContentRatioSlider: React.FC<ContentRatioSliderProps> = ({ ratio, setRatio, t }) => {
  return (
    <div>
      <label htmlFor="content-ratio-slider" className="block text-lg font-semibold text-brand-primary dark:text-gray-300 mb-2">
        {t('writer_ratio_label')}
      </label>
      <div className="flex items-center gap-4">
        <input
          id="content-ratio-slider"
          type="range"
          min="0"
          max="100"
          value={ratio}
